...
CREATE TABLE IF NOT EXISTS countries (
    country_code VARCHAR(2) PRIMARY KEY, -- ISO 3166-1 alpha-2 (BR, US, etc.)
    country_name VARCHAR(100) NOT NULL,
    region VARCHAR(50),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

-- Inserir alguns países comuns
...
('RE', 'Réunion', 'Africa'),
('RO', 'Romania', 'Europe'),
('RU', 'Russian Federation', 'Europe/Asia'),
('RW', 'Rwanda', 'Africa'),
...
('MF', 'Saint Martin (French part)', 'North America'),
